...
public class FragmentChild2 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_child_2, container, false);
            context = getContext();
        }
    ...
    private void initView() {
        imgPreview = (ImageView) view.findViewById(R.id.img_icon_preview_child_2);
        txtTitle = (TextView) view.findViewById(R.id.txtTitle_child2Frag);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerView_child_2);
...
//         set click listener
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.img_icon_preview_child_2:
                // lay ra fragment hien tai cua parent
                Fragment fragCurent = getFragmentManager().findFragmentById(R.id.container_childFrag);
    ...
    /*
    chac chan se goi List CT Huyen
     */
